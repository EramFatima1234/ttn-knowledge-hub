...
- Name: navigation.spec.ts >> Public navigation shell >> learning paths route requires authentication
- Location: e2e/navigation.spec.ts:16:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:3000/learning-paths
Call log:
  - navigating to "http://127.0.0.1:3000/learning-paths", waiting until "load"
